...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Run either CatBoostHyper or CatBoostKaggle or AutoGluonregression or autogluontrain or RandomForest classifier.")
    parser.add_argument("--classifier",
                        choices=["catboosthyp", "catboostkag", "autogluontrain", "AutoGluonregression",
...
def main():
    ...
    elif args.classifier == "catboostkag":
    ...
    elif args.classifier == "AutoGluonregression":
...
# }
#
# #model_save_path = os.path.join(script_dir, 'path/to/trained_model_catboost.pkl')
# #result_save_path = os.path.join(script_dir, 'path/to/prediction_catboost.csv')
#
...
#     # predictor = regressor.load_and_preprocess_data()
#
#     #2 Predict and save results
#     # regressor.predict_and_save_results(predictor)
#
#
# if __name__ == "__main__":
#     main()